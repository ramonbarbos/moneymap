...
class BancoList extends TPage
{
  ...
  public function __construct()
  {
    ...
    $campo1 = new TEntry('nome');


    $this->form->addFields([new TLabel('Nome do Banco')], [$campo1]);
    ...
    $this->form->addActionLink(_t('New'), new TAction(['BancoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
    ...
    $column_3 = new TDataGridColumn('codigo_banco', 'Banco', 'left',);
    ...
    $action1 = new TDataGridAction(['BancoForm', 'onEdit'], ['id' => '{id}', 'register_state' => 'false']);
