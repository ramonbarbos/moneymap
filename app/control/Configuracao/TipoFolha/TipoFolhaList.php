...
class TipoFolhaList extends TPage
{
    private $form;
    private $datagrid;
    ...
    public function __construct(){
        ...
        $this->setActiveRecord('TipoFolha');
        ...
        $this->form = new BootstrapFormBuilder('form_search_tipofolha');
        $this->form->setFormTitle('Tipo de Folha');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['TipoFolhaForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green'  );
        ...
        $action1 = new TDataGridAction(['TipoFolhaForm', 'onEdit'], ['id'=> '{id}', 'register_state' => 'false']);
    ...
    public function delete($param)
    {
        try {
            ...
            if (isset($param['id'])) {
                ...
                $tipo = new TipoFolha($id);
                $folhas = Folha::where('tp_folha', '=', $tipo->id)->load();
