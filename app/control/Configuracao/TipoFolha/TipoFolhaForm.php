...
class TipoFolhaForm extends TPage
{
  private $form;
  ...
  public function __construct()
  {
    ...
    $this->setAfterSaveAction(new TAction(['TipoFolhaList', 'onReload'], ['register_state' => 'true']));
    ...
    $this->form = new BootstrapFormBuilder('form_tipofolha');
