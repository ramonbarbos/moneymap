...
class DespesaFixaForm extends TPage
{
  private $form;
  ...
  public function __construct()
  {
    ...
    $col_desc = new TDataGridColumn('evento_id', 'Descrição', 'left', '60%');
  ...
  public static function onEventChange($params)
  {
    if (!empty($params['evento_id'])) {
      try {
        ...
        TForm::sendData('form_folha', (object) ['evento_descricao' => $eventos->descricao]);
        TTransaction::close();
      } catch (Exception $e) {
