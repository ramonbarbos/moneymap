...
class RelatorioFolha
{
  ...
  public function addCabecalhoProduto()
  {
    ...
    $this->pdf->Cell(315, 12, utf8_decode('Descrição'),  1, 0, 'L', 1);
  ...
  public function AddEvento($itemFolha)
  {
    ...
    $this->pdf->Cell(315, 12, utf8_decode($evento->descricao), 'LR', 0, 'L');
    $this->pdf->Cell(50,  12,   utf8_decode($evento->incidencia), 'LR', 0, 'C');
